...
public class PIntensionConstraint extends PConstraint {
	...
	public PIntensionConstraint(String name, String reference, PVariable[] scope, PFunction function, String effectiveParametersExpression) {
		super(name, reference, scope);
